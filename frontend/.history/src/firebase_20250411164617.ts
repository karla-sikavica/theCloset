...
import { getStorage } from "firebase/storage"; // ➕ ovo dodaš
...
const firebaseConfig = {
  ...
  storageBucket: "thecloset-7ba5e.appspot.app",
...
export const storage = getStorage(app); // ➕ ovo dodaš za spremanje slika
