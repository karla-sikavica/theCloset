...
const Add = () => {
  ...
  const validateForm = () => {
    ...
    if (!clothingItem.material.trim()) newErrors.material = "Material is required";
    if (!clothingItem.price || isNaN(Number(clothingItem.price))) newErrors.price = "Valid price is required";
    if (!clothingItem.category) newErrors.category = "Select a category";
    if (!clothingItem.subcategory) newErrors.subcategory = "Select a subcategory";
