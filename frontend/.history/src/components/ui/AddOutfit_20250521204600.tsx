          ...
          {itemsOnCanvas.map((entry, index) => (
            ...
            >
              <img
                 ...
                 */ src="https://firebasestorage.googleapis.com/v0/b/thecloset-7ba5e.appspot.com/o/images%2Fimage%20(18).jpg?alt=media&token=fed6bafb-e0f0-4669-95a0-9e4baa3c788b"
                alt={entry.item.name}
