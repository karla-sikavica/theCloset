...
function ImageItem({ src, alt }) {
  ...
  const randomSize = Math.random() * 100 + 100; // Image size between 100px - 200px
  ...
  return (
    ...
    >
      ...
      <motion.img
        src={src}
        alt={alt}
        className="transition-all duration-300 max-w-[200px] max-h-[200px]" // Added max size control
